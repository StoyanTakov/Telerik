namespace ExtensionMethodsDelegatesLambdaLINQ.Timer
{
    ...
    public class Subscriber
    {
        ...
        {
            timer.Task -= OnTask;
            Console.WriteLine($"{this.MaxCounter} seconds passed! Listening stopped!");
            Console.WriteLine("If that was the last listener you can stop the program with Ctrl+C");
        }
