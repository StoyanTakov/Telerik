namespace ExtensionMethodsDelegatesLambdaLINQ.Tests
{
    ...
    {
        // every method from group has comments that show what exactly it's testing - just separated to be easier to check results
        public static void Test()
        {
            var students = HardCodeStudents();

            // students who's first name is lexicographically before last 
            // with ext method
